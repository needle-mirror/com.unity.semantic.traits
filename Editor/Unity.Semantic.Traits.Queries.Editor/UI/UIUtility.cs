...
namespace UnityEditor.Semantic.Traits.Queries.UI
{
    ...
    {
        const string k_EditorUIAssetPath = "Packages/com.unity.semantic.traits/Editor/Unity.Semantic.Traits.Queries.Editor/UI/";
        ...
        private static StyleSheet LoadThemeStyleSheet(string path)
        {
